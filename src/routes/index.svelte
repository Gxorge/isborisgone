<script context="module" lang="ts">
	export const load = async ({ fetch }) => {
		...
		daysSinceStart = parseInt((Date.now() - startDate.getTime()) / 86400000);
...
<article>
	<section>
		...
		<p>
			...
			deaths, with {weekly.toLocaleString()} occurring just this week. While we made sacrifices, Boris and his team <a href="https://www.theguardian.com/politics/2022/feb/01/boris-johnson-attended-leaving-do-during-strict-january-lockdown">partied away</a> at No. 10 ignoring all social distancing rules.
		</p>

		<h3>Derogatory Remarks</h3>
		<p>
			Spicy jalapeno bacon ipsum dolor amet ham fatback tri-tip andouille beef ribs, kielbasa pork loin prosciutto landjaeger doner. Jowl sausage salami corned beef filet mignon bacon pig brisket doner swine meatball ground round. 
		</p>

		<h3>Serial Liar</h3>
		<p>
			Bacon ipsum dolor amet spare ribs kevin meatloaf salami pork loin pancetta. Pancetta sausage bacon strip steak tongue. Ham hock leberkas picanha capicola cupim t-bone. Cupim shoulder beef shankle. Bacon fatback cow ground round ham hock hamburger.
		</p>
	</section>
...
<footer>
	<p>Inspired by <a href="https://isgavgone.com/">IsGavGone.com</a> by <a href="https://jakegealer.me/">Jake Gealer</a></p>
	<!-- @big g, should this be credited to gabriella? -->
	<p>Made with 💞 by <a href="https://gabriella.moe/">Gabriella</a>, <a href="https://lewistehminerz.dev/">Lewis</a> &amp; <a href="https://tomr.me">Tom</a>.
</footer>